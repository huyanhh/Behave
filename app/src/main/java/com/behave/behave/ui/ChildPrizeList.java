...
//                            Log.d(String.valueOf(ptoke.second),"the number");
                            ...
                            if ((ptoke.first).equals(p) ){
                                ...
                                mKidRef.child(childId).child("prizeToken").setValue(ptoke.second);

                            }
                        }
                        //mKidRef.child(childId).child("prizes").child(p);
...
//                        Toast.makeText(this,to,Toast.LENGTH_SHORT).show();
                      ...
                      //  mRootRef.child(childId).child("isRedeeming").setValue(true);
                        ...
                        alert1.setTitle("Sorry you are already redeeming an item");
                        alert1.setMessage("Sorry you are already redeeming an item");
